...
#if swift(>=6)
internal import SwiftBasicFormatOld
internal import SwiftDiagnosticsOld
internal import SwiftOperatorsOld
internal import SwiftSyntaxOld
@_spi(MacroExpansion) @_spi(ExperimentalLanguageFeature) internal import SwiftSyntaxMacroExpansionOld
@_spi(ExperimentalLanguageFeature) internal import SwiftSyntaxMacrosOld
#else
import SwiftBasicFormatOld
import SwiftDiagnosticsOld
import SwiftOperatorsOld
import SwiftSyntaxOld
@_spi(MacroExpansion) @_spi(ExperimentalLanguageFeature) import SwiftSyntaxMacroExpansionOld
@_spi(ExperimentalLanguageFeature) import SwiftSyntaxMacrosOld
#endif
...
extension PluginProviderMessageHandler {
  ...
  func expandFreestandingMacro(
    ...
    do {
      ...
      expandedSource = SwiftSyntaxMacroExpansionOld.expandFreestandingMacro(
  ...
  func expandAttachedMacro(
    ...
    do {
      ...
      let expansions = SwiftSyntaxMacroExpansionOld.expandAttachedMacroWithoutCollapsing(
        definition: macroDefinition,
        macroRole: role,
      ...
      if let expansions, hostCapability.hasExpandMacroResult {
        ...
        expandedSources = [
          SwiftSyntaxMacroExpansionOld.collapse(
