...
@_spi(MacroExpansion) internal import SwiftParserOld
public import SwiftSyntaxOld
internal import SwiftSyntaxBuilderOld
@_spi(MacroExpansion) @_spi(ExperimentalLanguageFeature) public import SwiftSyntaxMacrosOld
#else
import SwiftDiagnosticsOld
import SwiftOperatorsOld
@_spi(MacroExpansion) import SwiftParserOld
import SwiftSyntaxOld
import SwiftSyntaxBuilderOld
@_spi(MacroExpansion) @_spi(ExperimentalLanguageFeature) import SwiftSyntaxMacrosOld
#endif
...
let diagnosticDomain: String = "SwiftSyntaxMacroExpansionOld"
