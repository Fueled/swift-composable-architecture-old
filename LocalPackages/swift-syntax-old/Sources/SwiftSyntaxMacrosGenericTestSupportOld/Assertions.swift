...
private import SwiftSyntaxMacrosOld
...
public struct TestFailureLocation {
  ...
  fileprivate init(underlying: _SwiftSyntaxGenericTestSupportOld.TestFailureLocation) {
    self.init(
  ...
  /// This type is intentionally different to `_SwiftSyntaxGenericTestSupportOld.TestFailureLocation` so we can
  /// import `_SwiftSyntaxGenericTestSupportOld` privately and don't expose its internal types.
  fileprivate var underlying: _SwiftSyntaxGenericTestSupportOld.TestFailureLocation {
    _SwiftSyntaxGenericTestSupportOld.TestFailureLocation(
...
public struct TestFailureSpec {
  ...
  fileprivate init(underlying: _SwiftSyntaxGenericTestSupportOld.TestFailureSpec) {
    self.init(
