      ...
      static func expansion(
        ...
        guard declaration.is(ActorDeclSyntax.self) else {
          throw DiagnosticsError(diagnostics: [
            Diagnostic(
              node: node,
              message: SwiftSyntaxMacrosOld.MacroExpansionErrorMessage("'@ActorOnly' is only applicable to actors."),
              fixIt: FixIt(
                message: SwiftSyntaxMacrosOld.MacroExpansionFixItMessage("Remove '@ActorOnly' attribute."),
                changes: [
