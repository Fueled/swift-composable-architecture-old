...
public struct CasePathableMacroOld {
  static let moduleName = "CasePathsOld"
  static let casePathTypeName = "AnyCasePath"
}

extension CasePathableMacroOld: ExtensionMacro {
...
extension CasePathableMacroOld: MemberMacro {
...
extension String {
  fileprivate var qualified: String {
    "\(CasePathableMacroOld.moduleName).\(self)"
  }
}
