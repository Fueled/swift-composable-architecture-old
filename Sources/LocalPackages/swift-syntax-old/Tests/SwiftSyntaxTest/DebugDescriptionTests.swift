  ...
  public func testDump() {
    ...
    let testCases: [UInt: TestCase] = [
      #line: .init(
        ...
        expectedDumped: """
          ▿ keyword(SwiftSyntaxOld.Keyword.associatedtype)
            - text: "associatedtype"
            ▿ leadingTrivia: []
              - pieces: 0 elements
            ▿ trailingTrivia: []
              - pieces: 0 elements
            ▿ tokenKind: SwiftSyntaxOld.TokenKind.keyword
              - keyword: SwiftSyntaxOld.Keyword.associatedtype
          ...
          expectedDumped: """
            ▿ SwiftSyntaxOld.TokenSequence
              ▿ leftSquare
                ...
                ▿ trailingTrivia: []
                  - pieces: 0 elements
                - tokenKind: SwiftSyntaxOld.TokenKind.leftSquare
              ▿ rightSquare
                - text: "]"
                ▿ leadingTrivia: []
                  - pieces: 0 elements
                ▿ trailingTrivia: []
                  - pieces: 0 elements
                - tokenKind: SwiftSyntaxOld.TokenKind.rightSquare
      ...
      #line: {
        ...
        return .init(
          ...
          expectedDumped: """
            ▿ SwiftSyntaxOld.ReversedTokenSequence
              ▿ rightSquare
                - text: "]"
                ▿ leadingTrivia: []
                  - pieces: 0 elements
      ...
      #line: {
        ...
        return .init(
          ...
          expectedDumped: """
            ▿ Swift.ReversedCollection<SwiftSyntaxOld.LabeledExprListSyntax>
