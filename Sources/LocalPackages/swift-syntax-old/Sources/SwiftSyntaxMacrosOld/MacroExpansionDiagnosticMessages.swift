...
#if swift(>=6)
public import SwiftDiagnosticsOld
#else
import SwiftDiagnosticsOld
#endif

fileprivate let diagnosticDomain: String = "SwiftSyntaxMacrosOld"
...
public struct MacroExpansionErrorMessage: Error, DiagnosticMessage {
  ...
  public var severity: SwiftDiagnosticsOld.DiagnosticSeverity { .error }

  public var diagnosticID: SwiftDiagnosticsOld.MessageID {
...
public struct MacroExpansionWarningMessage: DiagnosticMessage {
  ...
  public var severity: SwiftDiagnosticsOld.DiagnosticSeverity { .warning }
...
public struct MacroExpansionFixItMessage: FixItMessage {
  ...
  public var fixItID: SwiftDiagnosticsOld.MessageID {
    .init(domain: diagnosticDomain, id: "\(Self.self)")
  }
...
public struct MacroExpansionNoteMessage: NoteMessage {
  ...
  public var noteID: SwiftDiagnosticsOld.MessageID {
    .init(domain: diagnosticDomain, id: "\(Self.self)")
  }
