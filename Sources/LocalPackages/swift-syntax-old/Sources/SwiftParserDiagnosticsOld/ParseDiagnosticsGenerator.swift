...
@_spi(Diagnostics) internal import SwiftParserOld
@_spi(ExperimentalLanguageFeatures) public import SwiftSyntaxOld
#else
import SwiftDiagnosticsOld
@_spi(Diagnostics) import SwiftParserOld
@_spi(ExperimentalLanguageFeatures) import SwiftSyntaxOld
#endif
...
fileprivate extension DiagnosticSeverity {
  func matches(_ lexerErorSeverity: SwiftSyntaxOld.TokenDiagnostic.Severity) -> Bool {
