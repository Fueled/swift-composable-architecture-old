...
#if swift(>=6)
private import _SwiftSyntaxCShimsOld
public import SwiftSyntaxMacrosOld
#else
@_implementationOnly import _SwiftSyntaxCShimsOld
...
#error("Building swift-syntax-old for WebAssembly requires compiler version 6.0 or higher.")
