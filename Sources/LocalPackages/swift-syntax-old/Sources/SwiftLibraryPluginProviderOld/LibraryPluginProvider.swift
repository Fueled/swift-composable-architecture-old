...
@_spi(PluginMessage) public import SwiftCompilerPluginMessageHandlingOld
private import _SwiftLibraryPluginProviderCShimsOld
// NOTE: Do not use '_SwiftSyntaxCShimsOld' for 'dlopen' and 'LoadLibraryW' (Windows)
...
@_spi(PluginMessage) import SwiftCompilerPluginMessageHandlingOld
@_implementationOnly import _SwiftLibraryPluginProviderCShimsOld
#if canImport(Darwin)
...
public class LibraryPluginProvider: PluginProvider {
  ...
  public func resolveMacro(moduleName: String, typeName: String) throws -> SwiftSyntaxMacrosOld.Macro.Type {
