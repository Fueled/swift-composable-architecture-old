...
public import SwiftParserOld
internal import SwiftParserDiagnosticsOld
internal import SwiftSyntaxOld
// Don't introduce a dependency on OSLog when building SwiftSyntaxOld using CMake
// for the compiler.
...
extension SyntaxParseable {
  ...
  private func logStringInterpolationParsingError() {
      ...
      !suppressStringInterpolationParsingErrors
    {
      ...
      Logger(subsystem: "org.swift.swift-syntax-old", category: "ParseError").fault(
        """
        ...
        To explicitly support parsing of invalid source code, import SwiftParserOld and invoke the parser as follows
