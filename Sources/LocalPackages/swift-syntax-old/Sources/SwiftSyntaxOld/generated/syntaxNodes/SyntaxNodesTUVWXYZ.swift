...
/// ```
/// 
/// - Note: This node is only generated after operators are folded using the `SwiftOperatorsOld` library. 
...
///   After operator folding using the `SwiftOperatorsOld` library, this gets translated to an ``AsExprSyntax``.
///
/// ### Children
/// 
///  - `asKeyword`: `as`
...
///   After operator folding using the `SwiftOperatorsOld` library, this gets translated to an ``IsExprSyntax``.
///
/// ### Children
/// 
///  - `isKeyword`: `is`
...
///   After operator folding using the `SwiftOperatorsOld` library, this gets translated to an ``TernaryExprSyntax``.
///
/// ### Children
/// 
///  - `questionMark`: `?`
