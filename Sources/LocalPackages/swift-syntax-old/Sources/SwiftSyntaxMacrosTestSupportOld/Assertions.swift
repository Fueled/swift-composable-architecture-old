...
#if swift(>=6.0)
public import SwiftSyntaxOld
public import SwiftSyntaxMacroExpansionOld
public import SwiftSyntaxMacrosOld
@_spi(XCTestFailureLocation) public import SwiftSyntaxMacrosGenericTestSupportOld
private import XCTest
#else
import SwiftSyntaxOld
import SwiftSyntaxMacroExpansionOld
import SwiftSyntaxMacrosOld
@_spi(XCTestFailureLocation) import SwiftSyntaxMacrosGenericTestSupportOld
import XCTest
#endif

// Re-export the spec types from `SwiftSyntaxMacrosGenericTestSupportOld`.
public typealias NoteSpec = SwiftSyntaxMacrosGenericTestSupportOld.NoteSpec
public typealias FixItSpec = SwiftSyntaxMacrosGenericTestSupportOld.FixItSpec
public typealias DiagnosticSpec = SwiftSyntaxMacrosGenericTestSupportOld.DiagnosticSpec
...
public func assertMacroExpansion(
  ...
  SwiftSyntaxMacrosGenericTestSupportOld.assertMacroExpansion(
    originalSource,
    expandedSource: expectedExpandedSource,
    diagnostics: diagnostics,
